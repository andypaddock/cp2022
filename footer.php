        ...
        <div class="footer-hero" style="background-image:  url(<?php echo $footerImage['url']; ?>)">
            ...
            <div class="row">
                <div class="footer_link">
                    ...
                    ?>
                        <a class="footer_button" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?><span class="link-arrow arrow-right"></span></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="footer-text-container push-right">
                    ...
                    <div class="footer-text-block fmright">
                        ...
                        <h5 class="heading-primary"> <span class="heading-primary--tertiary"><?php the_field('footer_sub_heading', 'options'); ?></span></h5>
                        <?php
            ...
            <div class="row">
                <div class="footer-navbar">
                    <div class="footer-social">
                        <div class="logo"><a href="<?php echo site_url(); ?>"><?php get_template_part("inc/img/cplogotxt"); ?></a>
                        </div>
                    </div>
                                ...
                                <?php while (have_rows('social_media_links', 'options')) : the_row(); ?>
                                    <li>
                                        ...
                                        if ($link) :
                                            ...
                                            $link_target = $link['target'] ? $link['target'] : '_self';
                                        ?>
                                            <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php the_sub_field('font_awesome_icon', 'options'); ?></a>
                                        <?php endif; ?>
                                    </li>
                                <?php endwhile; ?>
                            </ul>
