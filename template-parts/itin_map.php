...
<section
    ...
    <div class="itin-map"><div id="map"></div>
<div class="overlay">
        ...
        'features': [
            {
                ...
                'geometry': {
                    'type': 'LineString',
                    'coordinates': [origin, origin2, origin3, origin4, origin5, destination,]
                }
            }
        ]
    };
