...
<section class="image-text <?php if ($bgColor == true) : echo 'alt-bg';
    ...
    <div class="row <?php the_sub_field('column_size'); ?>">
        ...
        <div class="split-col">
            ...
            <div class="image-advert fmleft background-image" style="background-image: url(<?php echo $largeImage['url']; ?>)">
            </div>
